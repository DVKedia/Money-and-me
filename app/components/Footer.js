      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">Money & Me</h3>
            <p className="text-gray-300 mb-4">
              Your trusted partner in wealth management and financial planning. 
              Building secure financial futures through expert guidance and personalized strategies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/investments" className="text-gray-300 hover:text-blue-400 transition-colors">Investments</Link></li>
              <li><Link href="/tools" className="text-gray-300 hover:text-blue-400 transition-colors">Calculators</Link></li>
              <li><Link href="/testimonials" className="text-gray-300 hover:text-blue-400 transition-colors">Testimonials</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-gray-300">
                ...
                <span className="block">✉️ info@moneyandme.com</span>
